...
public class Test {
    ...
    @RequestMapping("getmac2")
    public void getmac2(HttpServletRequest request){

//        return MACUtil.getCurrentIpLocalMac();
...
//////        System.out.println(currentIpLocalMac);


        System.out.println(MACUtil.getSerialNumber("C"));
        /**
         * 1156731515
         * 1156731515
         */
