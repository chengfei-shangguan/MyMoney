...
//        Map[] map=new Map[]{};
        Point[] ps = new Point[] { //114.309914,30.599556
//                new Point(0.0,0.0),//114.295688,30.592879
                new Point(0.0,5.0),
                new Point(5.0,5.0),//114.292812,30.587726
                new Point(5.0,0.0)};//114.323282,30.592786
...
//                new Point(114.323282,30.592786)};//114.323282,30.592786
     ...
     * 模拟固定点
     */
    public static Point dotData(){

//        Point n1 = new Point(3.0,3.0);
        Point n2 = new Point(2.0,2.0);
